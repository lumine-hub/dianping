...
public class VoucherOrderServiceImpl3 extends ServiceImpl<VoucherOrderMapper, VoucherOrder> implements IVoucherOrderService {
    ...
    public Result seckillVoucher(Long voucherId) {
        ...
        // 2.4放到消息队列
        kafkaTemplate.send(SeckillConstants.SECKILL_ORDER_INFO_TOPIC, JSON.toJSONString(voucherOrder));
        // 3.返回订单id
        return Result.ok(orderId);
    }


    @KafkaListener(topics = SeckillConstants.SECKILL_ORDER_INFO_TOPIC)
